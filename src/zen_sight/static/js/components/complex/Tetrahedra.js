...
class Tetrahedra {
    ...
    setData(data) {
        ...
        console.log("[Tetrahedra] Setting data with", this.tetrahedraData.length, "tetrahedra");
    ...
    update() {
        ...
        if ((this.needsUpdate || this._isFirstRender) && this.initialized && this.scene) {
    ...
    _renderTetrahedra() {
        ...
        if (this.meshes && this.meshes.length > 0) {
            console.log("[Tetrahedra] Cleaning up", this.meshes.length, "previous meshes");
        ...
        this.tetrahedraData.forEach((tetra, index) => {
            if (tetra.vertices && tetra.vertices.length >= 4) {
                ...
                if (!allVerticesFound || vertexPositions.length < 4) {
                    console.log(`[Tetrahedra] Skipping tetrahedron ${index} - missing vertices`);
                    return;
                }
